...
do_something = [
    ...
    {'name': '看废萌番', 'good': '萌即正义', 'bad': '除了卖萌什么也没有'},
    {'name': '看致郁番', 'good': '从深度晦涩的内涵与悲剧中获得了精神的洗礼', 'bad': '猎奇与扭曲的价值观让你萎靡不振'},
    ...
    {'name': '前往女仆咖啡厅', 'good': '感受身心上的治愈', 'bad': '终究是虚假的情景，只会让你内心更加空虚'},
    {'name': '女装Cosplay', 'good': '好评如潮', 'bad': '照片传到班级群还被认出来'},
    {'name': '夜景Cosplay', 'good': '好评如潮', 'bad': '片子拍糊了'},
    {'name': 'Cosplay新番角色', 'good': '神速涨粉', 'bad': '被跟风撞角色'},
    {'name': 'Cosplay老番角色', 'good': 'Get隐藏同好', 'bad': '没人认出你的角色'},
    {'name': '修仙', 'good': '有了能突破到下一个境界的预感', 'bad': '会在进阶中遭受心魔侵蚀'},
    {'name': '渡劫', 'good': '万事俱备，只待飞升', 'bad': '没能扛过去，寿元终'},
    {'name': '吃金坷垃', 'good': '小麦会亩产一千八', 'bad': '会变得和蠢球一样蠢'},
    {'name': '写一些高深的东西', 'good': '有利于建立威信', 'bad': '你会被认为是在装逼'},
    ...
    {'name': '学习姿势', 'good': '你今天对新姿势的嗅觉大大提高', 'bad': '老师是比♂利♂王'},
    {'name': '卖蠢', 'good': '拉进和菊苣的距离', 'bad': '真的变蠢了OvO'},
    {'name': '上微博', 'good': '今天的瓜不能错过', 'bad': '被智障发言糊一脸'},
    {'name': '自黑', 'good': '你会得到人们的赞许', 'bad': '真的黑了'},
    {'name': '作死', 'good': '节目效果一流', 'bad': '吾之旧友弔似汝，如今坟头草丈五'},
    {'name': '看老黄历', 'good': '反正你已经看了', 'bad': '反正你已经看了'},
    {'name': '学习一门新技能', 'good': '有会成为大神的资质', 'bad': '可能会误入歧途'},
    {'name': '批量删好友', 'good': '一下子舒服多了', 'bad': '啊嘞，删错了'},
    {'name': '睡懒觉', 'good': '避免内存不足', 'bad': '错过重要的事情'},
    {'name': '玩Minecraft', 'good': '你将如有神助', 'bad': '启动器都会崩溃'},
    {'name': '补番', 'good': '你会后悔没早点看这部番', 'bad': '你会后悔看了这部番'},
    {'name': '漫展出摊', 'good': '分分钟完售', 'bad': '隔壁的队总比自家的长'},
    {'name': '上台演出', 'good': '全场打call气氛热烈', 'bad': '发生各种小事故'},
    {'name': '找素材', 'good': '瞬间找到，要的就是它', 'bad': '翻了几十页全是奇怪的图'},
