...
UP_OPERATOR: list[UpEvent] = [
    UpEvent(
        star=6,
        operator=[
            Operator(name='菲亚梅塔/Fiammetta', star=6, limited=False, recruit_only=False, event_only=False,
                     special_only=False),
            Operator(name='棘刺/Thorns', star=6, limited=False, recruit_only=False, event_only=False,
                     special_only=False),
        ],
        zoom=0.5
    ),
    UpEvent(
        star=5,
        operator=[
            Operator(name='夜半/Blacknight', star=5, limited=False, recruit_only=False, event_only=False,
                     special_only=False),
            Operator(name='安哲拉/Andreana', star=5, limited=False, recruit_only=False, event_only=False,
                     special_only=False),
            Operator(name='极境/Elysium', star=5, limited=False, recruit_only=False, event_only=False,
                     special_only=False),
        ],
        zoom=0.5
    )
...
ALL_OPERATOR: list[Operator] = [
    Operator(name='圣约送葬人/Executor the Ex Foedere', star=6, limited=False, recruit_only=False, event_only=False,
             special_only=False),
    Operator(name='空构/Spuria', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='隐现/Insider', star=5, limited=False, recruit_only=False, event_only=True, special_only=False),
    Operator(name='Friston-3/Friston-3', star=1, limited=False, recruit_only=True, event_only=False,
             special_only=False),
    Operator(name='缪尔赛思/Muelsyse', star=6, limited=True, recruit_only=False, event_only=False, special_only=False),
    Operator(name="霍尔海雅/Ho'olheyak", star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='淬羽赫默/Silence the Paradigmatic', star=6, limited=False, recruit_only=False, event_only=True,
             special_only=False),
    Operator(name='玫拉/Melanite', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='伊内丝/Ines', star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='洋灰/Cement', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='摩根/Morgan', star=5, limited=False, recruit_only=False, event_only=True, special_only=False),
    Operator(name='休谟斯/Humus', star=4, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='U-Official/U-Official', star=1, limited=False, recruit_only=False, event_only=True,
             special_only=False),
    Operator(name='麒麟X夜刀/Kirin X Yato', star=6, limited=True, recruit_only=False, event_only=True,
             special_only=False),
    Operator(name='火龙S黑角/Rathalos S Noir Corne', star=5, limited=True, recruit_only=False, event_only=True,
             special_only=False),
    Operator(name='泰拉大陆调查团/Terra Research Commission', star=1, limited=False, recruit_only=False, event_only=True,
             special_only=False),
    Operator(name='仇白/Qiubai', star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='铎铃/Wind Chimes', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='重岳/Chongyue', star=6, limited=True, recruit_only=False, event_only=False, special_only=False),
    Operator(name='林/Lin', star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='火哨/Firewhistle', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='截云/Jieyun', star=5, limited=False, recruit_only=False, event_only=True, special_only=False),
    Operator(name='焰影苇草/Reed The Flame Shadow', star=6, limited=False, recruit_only=False, event_only=False,
             special_only=False),
    Operator(name='和弦/Harmonie', star=5, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name='谜图/Puzzle', star=5, limited=False, recruit_only=False, event_only=True, special_only=False),
    Operator(name='缄默德克萨斯/Texas the Omertosa', star=6, limited=True, recruit_only=False, event_only=False,
             special_only=False),
