...
class TarotCards:
    ...
    ace_of_wands: TarotCard = field(default=TarotCard(
        ...
        upright='蕰涵创造力、重大事件的开端、新的发明诞生了、开始一段冒险旅程、新的机会出现， 实现梦想的好时机。',
        reversed='错误的开始、乌云密布的前景、态势不佳的、计划取消的、可能失败的、前途不太明朗的、没有耐心的。'
    ), init=False)
    ...
    two_of_wands: TarotCard = field(default=TarotCard(
        ...
        upright='具有勇气的、做出决定的、承担风险、达到目标和需要、无畏无惧的、负责尽职的勇气、正确运用手中的权利。',
        reversed='迟疑不决的、谨慎行事的、出现意外的、进展遇到麻烦的、行动受到拘束的、生活穷困潦倒的。'
    ), init=False)
    ...
    three_of_wands: TarotCard = field(default=TarotCard(
        ...
        upright='已经或者将会获得成功的、没有阻碍的、快速增长的、良好势头的、展望未来、信心增长、探索新方向的。',
        reversed='发展倒退的、计划延迟的、事业被终止的、受挫的、缺乏远见的、计划被延迟的。'
    ), init=False)
    ...
    four_of_wands: TarotCard = field(default=TarotCard(
        ...
        upright='和平繁荣的、美满的家庭、关系稳固的、事业稳定的、庆祝和团聚的、安顿与休息的。',
        reversed='缺乏支持的、失去基础的、失去平衡的、家庭冲突的、不稳定的、关系出现裂痕的。'
    ), init=False)
