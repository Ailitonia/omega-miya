...
async def stick_maker_temp_petpet(
    ...
    def __handle() -> Optional[bytes]:
        ...
        bg0.paste(image_file.resize((95, 95)), (14, 16))
        bg1.paste(image_file.resize((97, 75)), (14, 36))
        bg2.paste(image_file.resize((98, 65)), (14, 46))
        bg3.paste(image_file.resize((96, 80)), (14, 31))
        bg4.paste(image_file.resize((95, 90)), (14, 21))
