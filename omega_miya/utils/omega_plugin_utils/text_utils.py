...
class TextUtils(object):
    ...
    def __text_to_img(
        ...
        # 按长度切分文本
        text_ = self.split_multiline(width=int(image_width * 0.75), font=font)
    ...
    async def text_to_img(
        ...
        def __handle():
            img_ = self.__text_to_img(image_width=image_width, font_name=font_name)
            # 检查生成图片路径
