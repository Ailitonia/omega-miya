...
class SystemSettingOrm(Base):
    ...
    setting_name: Mapped[str] = mapped_column(
        String(64), primary_key=True, nullable=False, index=True, unique=True, comment='参数名称'
    )
    setting_value: Mapped[str] = mapped_column(String(4096), nullable=False, index=True, comment='参数值')
