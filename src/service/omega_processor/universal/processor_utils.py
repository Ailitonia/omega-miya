...
__OMEGA_STATE_KEY: str = '_OMEGA_INTERNAL_PROCESSOR'
...
class OmegaProcessorState(OmegaServiceBaseModel):
    ...
    cooldown: int
    cooldown_type: Literal['global', 'event', 'user']
    cost: float
...
def enable_processor_state(
        ...
        *,
        ...
        cooldown: int = 0,
        cooldown_type: Literal['global', 'event', 'user'] = 'event',
        cost: float = 0,
