...
async def get_tarot_resource_name(interface: 'EVENT_MATCHER_INTERFACE') -> str | None:
...
async def set_tarot_resource(resource_name: str, interface: 'EVENT_MATCHER_INTERFACE') -> None:
