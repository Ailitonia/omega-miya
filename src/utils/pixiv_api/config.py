...
class PixivLocalResourceConfig:
    ...
    default_preview_font: StaticResource = default_font_folder('fzzxhk.ttf')
    # 默认的缓存资源保存路径
    default_artwork_folder: TemporaryResource = TemporaryResource('pixiv', 'artwork')
    default_download_folder: TemporaryResource = TemporaryResource('pixiv', 'download')
    default_ugoira_gif_folder: TemporaryResource = TemporaryResource('pixiv', 'ugoira_gif')
    # 图片绘制相关参数
    default_preview_img_folder: TemporaryResource = TemporaryResource('pixiv', 'preview')
